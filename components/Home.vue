<template>
    <div id="home" :class="'flex items-center justify-center flex-col pt-8 md:pt-12 lg:pt-16 2xl:pt-24 pb-8 md:pb-12 lg:pb-16 2xl:pb-24 transition-colors duration-300' + (darkMode ? ' bg-gray-600' : ' bg-gray-50')">
        ...
        <p :class="'mt-4 md:mt-6 mx-5 text-center text-sm md:text-base lg:text-base xl:text-lg 2xl:text-xl font-light' + (darkMode ? ' text-gray-100' : '')">Desarrollador web con más de 3 años de experiencia trabajando con equipos angloparlantes.</p>
        <p :class="'mt-1 sm:mt-0 mx-5 text-center text-sm md:text-base lg:text-base xl:text-lg 2xl:text-xl font-light' + (darkMode ? ' text-gray-100' : '')">Con capacidad para desarrollar software mantenible, funcional, seguro y documentado.</p>
