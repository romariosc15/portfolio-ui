<template>
    <div id="home" class="flex items-center justify-center h-screen flex-col bg-gray-50">
        ...
        <p class="mt-1 sm:mt-0 mx-5 text-center text-sm md:text-base lg:text-lg 2xl:text-xl text-gray-500">Con capacidad para desarrollar software mantenible, funcional, seguro y documentado.</p>
