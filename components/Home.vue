<template>
    <div id="home" :class="'flex items-center justify-center flex-col pt-8 md:pt-12 lg:pt-16 2xl:pt-24 pb-8 md:pb-12 lg:pb-16 2xl:pb-24 transition-colors duration-300' + (darkMode ? ' bg-gray-600' : ' bg-gray-50')">
        <img :class="'w-44 h-44 md:w-64 md:h-64 2xl:w-72 2xl:h-72 rounded-full object-cover border-4 md:border-8' + (darkMode ? ' border-gray-50' : ' border-gray-300')" src="~/assets/img/home/main.jpg" alt="Imagen de Romario Sarmiento" />
