<template>
    <div id="portfolio" class="h-screen bg-gray-50">
        <div class="md:mx-12 lg:mr-0 lg:mx-12 xl:mx-20 pt-24 col-span-5">
            <h1 class="md:text-5xl lg:text-6xl xl:text-7xl font-extrabold">Portafolio</h1>
            <p class="mt-8 md:text-lg lg:text-lg xl:text-xl font-light text-justify text-gray-500">En esta sección podrás encontrar los proyectos que he desarrollado para demostrar mis habilidades como desarrollador web.</p>
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
                <div>
                    <img class="w-full h-fit-content rounded-md" src="~/assets/img/portfolio/project-1.jpg" />
                    <p class="mt-4 font-medium md:text-lg lg:text-lg xl:text-xl">Tienda virtual</p>
                    <p class="font-light md:text-md lg:text-md xl:text-lg text-gray-600">Desarrollado con React y Redux.</p>
                ...
                <div>
                    <img class="w-full h-fit-content rounded-md" src="~/assets/img/portfolio/project-2.jpg" />
                    <p class="mt-4 font-medium md:text-lg lg:text-lg xl:text-xl">API REST</p>
                    <p class="font-light md:text-md lg:text-md xl:text-lg text-gray-600">Desarrollada con Node.js.</p>
                    <div class="mt-4 space-x-4">
